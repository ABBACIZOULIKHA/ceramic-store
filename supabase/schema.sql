...
insert into public.faience (nom, disponibilite, format, aspect, epaisseur, marque) values
  ('Carrelage Grège 60x60', 'En stock', '60 × 60', 'Béton', '9mm', 'Ceramica'),
  ('Faïence Murale Blanche 30x30', 'Sur commande', '30 × 30', 'Uni', '12mm', 'Mosaic');

insert into public.bathroom (nom, disponibilite, dimensions, poids, absorption, retrait, prix) values
  ('Lavabo sur pied Classique', 'En stock', '60 × 45 × 85 cm', '18 kg', '< 0.5%', '1.2%', 24500),
  ('WC suspendu Design', 'En stock', '55 × 36 cm', '24 kg', '< 0.5%', '1.0%', 38900);
